...
docker run -dt --name=bitcoin_0.14 -p 8333:8332 -p 18333:18332 -v ${SCRIPT_PATH}/0.14/:/home/bitcoin/.bitcoin ruimarinho/bitcoin-core:0.14-alpine
-testnet -prune=4096 -printtoconsole -debug
docker run -dt --name=bitcoin_0.15 -p 8332:8332 -p 18332:18333 -v ${ROOT_PATH}/0.15/:/home/bitcoin/.bitcoin ruimarinho/bitcoin-core:0.15-alpine
-testnet -debug -printtoconsole
